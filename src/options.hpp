...
OPTION( ere,               1,  0,  1,0,1,0, "ERE") \
OPTION( ereclslim,       1e2,  0,2e9,0,0,1, "ERE resolvent size limit") \
OPTION( ereeffort,         5,  0,1e6,0,0,1, "relative effort per mille") \
OPTION( ereirredonly,      1,  0,  1,0,0,1, "only resolve irredundant clauses") \
OPTION( ereirredonlyrem,   0,  0,  1,0,0,1, "only remove irredundant clauses") \
OPTION( ereocclim,       1e3,  0,2e9,0,0,1, "ERE occurrence list limit") \
OPTION( ereredonlyrem,     0,  0,  1,0,0,1, "only remove redundant clauses") \
