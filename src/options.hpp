...
OPTION( deduplicateallinit,   0,  0,  1,0,1,1, "deduplicate once before solving") \
...
OPTION( luckylimitpercls,     8,  1,1e9,0,0,1, "ticks limit for lucky (roughly maximum number of visits per clause") \
