...
#define decide_wrapper decide
  ...
  int allrpr_last_size_after_reset = 0;
  bool allrpr_need_reset = false;
  allrpr_proof_clauses allrpr_pcs;
  signed char &allrpr_mark (int lit, allrpr_proof_clauses &pcs);
  const signed char &allrpr_mark(int lit, const allrpr_proof_clauses &pcs) const;
  inline bool is_true (int lit, const allrpr_proof_clauses &pcs) const;   
  inline bool is_false (int lit, const allrpr_proof_clauses &pcs) const;  
  inline bool is_target (int lit, const allrpr_proof_clauses &pcs) const; 
  inline bool is_worked (int lit, const allrpr_proof_clauses &pcs) const;
  inline bool is_in_kitten (int lit, const allrpr_proof_clauses &pcs) const;
  inline bool is_base (int lit, const allrpr_proof_clauses &pcs) const;
  ...
  void allrpr_clear_added_flags ();
  void allrpr_check_kitten_and_pcs ();

  void allrpr_sort_shrunken();

  inline bool clause_is_qualified (Clause *c, int &prop_lit, const allrpr_proof_clauses &pcs);
